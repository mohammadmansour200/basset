...
function FileUpload({ setFilePath }: IFileUploadProps) {
	const { t } = useTranslation();

	//Crucial for cutting media files!
	useEffect(() => {
...
function OpenFileIcon() {
	return (
		// biome-ignore lint/a11y/noSvgWithoutTitle: SVG icon title ins't needed here
		<svg
			viewBox="0 0 24 24"
			width="30px"
			height="30px"
